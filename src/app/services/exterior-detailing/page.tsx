...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Professional exterior auto detailing in Waterford Township, MI. Hand wash, hand wax, tire shine, rim cleaning, and door jamb detail. From $125 to $175.",
    url: "https://www.waterfordautoshine.com/services/exterior-detailing",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Exterior Detailing", item: "https://www.waterfordautoshine.com/services/exterior-detailing" },
  ],
};
